...
public class FastLoggingFormatter implements LoggingFormatter {
    ...
    public FastLoggingFormatter(boolean requireAllValues, boolean mainMessageIsLast, boolean quoted) {
        this(requireAllValues, mainMessageIsLast, quoted, DEFAULT_CAPACITY);
    }

    public FastLoggingFormatter(boolean requireAllValues, boolean mainMessageIsLast, boolean quoted, int stringBuilderCapacity) {
